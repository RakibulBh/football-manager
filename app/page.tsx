    ...
    <div className="h-full w-full flex">
      ...
      <main className="h-full flex-1 p-4 flex flex-col gap-y-4">
        <div className="p-4 flex justify-center w-full h-[200px] lg:h-[400px] bg-[#725BF4] rounded-lg">
          <div className="w-full lg:max-w-[60%] h-full flex justify-between items-center">
            <Team imageUrl='/inter.png'/>
            <div className="gap-y-3 flex flex-col items-center text-center">
              <p className="text-sm font-bold">last match 07/05/2024</p>
              <p className="text-6xl font-bold">1:0</p>
            </div>
            <Team imageUrl='/inter.png'/>
          </div>
        </div>
